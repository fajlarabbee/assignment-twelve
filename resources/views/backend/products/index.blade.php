...
@section('content')
    ...
    <div class="panel mt-6">
        ...
        <h5 class="mb-5 text-lg font-semibold dark:text-white-light md:top-[25px] md:mb-5">Products</h5>
        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
            <div class="dataTable-container">
                <table id="products-table" class="whitespace-nowrap">
                    <thead>
                    <tr>
                        <th style="width: 21.0289%;"><a href="#">ID</a></th>
                        <th style="width: 13.119%;"><a href="#">Name</a></th>
                        <th style="width: 9.32476%;"><a href="#">Thumbnail</a></th>
                        <th style="width: 13.8907%;"><a href="#" >Price</a></th>
                        <th style="width: 25.9164%;"><a href="#">Stock</a></th>
                        <th style="width: 16.7203%;"><a href="#">Actions</a></th>
                    </tr>
                    </thead>
                    <tbody>
                   @foreach($products as $key => $product)
                       <tr>
                           ...
                           <td>
                               <div class="flex items-center w-max"><img
                           ...
                           <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                               <a  href="{{ route('product.edit', $product->id) }}" type="button" x-tooltip="Edit">
