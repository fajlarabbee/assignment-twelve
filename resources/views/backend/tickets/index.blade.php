@extends('backend.app')
@section('title', 'Tickets' . ' | ' . getenv('APP_NAME'))
@section('crumb-text', 'Tickets')
...
@section('content')
    ...
    <div class="panel mt-6">
        ...
        <div class="panel-header flex items-center mb-5 md:mb-5 md:top-[25px]">
            ...
            <x-custom.link :url="route('dashboard.tickets.create')">Add New</x-custom.link>
        </div>
            ...
            <div class="dataTable-container">
                <table id="products-table" class="whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <th style="width: 30%;"><a href="#">User Name</a></th>
                        <th style="width: 30%;"><a href="#">Route</a></th>
                   ...
                   @foreach($tickets as $ticket)
                       <tr>
                           ...
                           <td>{{ $ticket->trip->departureLocation->name }}</td>
                           <td>{{ $ticket->trip->destinationLocation->name }}</td>
                           <td></td>
                           <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                               <a  href="{{ route('locations.edit', $ticket->id) }}" type="button" x-tooltip="Edit">
                               ...
                               <form action="{{ route('locations.destroy', $ticket->id) }}" method="POST" class="inline-block">
                                   @csrf
                                   @method('DELETE')
