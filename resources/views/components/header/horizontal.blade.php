    ...
    <div class="shadow-sm">
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2">
                <a href="{{ route('search.index') }}" class="main-logo flex shrink-0 items-center">
            ...
            >
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    >
                        ...
                        @guest
                            <li>
                                <a href="{{ route('login') }}" class="dark:hover:text-white" @click="toggle">
                                    <svg
                            ...
                            <li>
                                <a href="{{ route('register') }}" class="dark:hover:text-white" @click="toggle">
                                    <svg
                                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                                        width="18"
                                        height="18"
                        ...
                        @auth
                            <li>
                                <a href="{{ route('dashboard.tickets.index') }}" class="dark:hover:text-white" @click="toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M64 64C28.7 64 0 92.7 0 128v64c0 8.8 7.4 15.7 15.7 18.6C34.5 217.1 48 235 48 256s-13.5 38.9-32.3 45.4C7.4 304.3 0 311.2 0 320v64c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V320c0-8.8-7.4-15.7-15.7-18.6C541.5 294.9 528 277 528 256s13.5-38.9 32.3-45.4c8.3-2.9 15.7-9.8 15.7-18.6V128c0-35.3-28.7-64-64-64H64zm64 112l0 160c0 8.8 7.2 16 16 16H432c8.8 0 16-7.2 16-16V176c0-8.8-7.2-16-16-16H144c-8.8 0-16 7.2-16 16zM96 160c0-17.7 14.3-32 32-32H448c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H128c-17.7 0-32-14.3-32-32V160z"/>
                                    </svg>&nbsp;&nbsp;Tickets</a
                                >
                            </li>
                            <li class="border-t border-white-light dark:border-white-light/10">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="!py-3 text-danger flex items-center px-4" @click="toggle">
                                        <svg
                ...
                <ul class="sub-menu">
                    ...
                    <li class="relative">
                        ...
                        >
                            ...
                            <li>
                                <a href="datatables-multi-column.html" class="active">Multi Column</a>
                            </li>
                            <li>
