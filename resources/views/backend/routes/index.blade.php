...
@section('content')
    ...
    <div class="panel mt-6">
        ...
        <div class="panel-header flex items-center mb-5 md:mb-5 md:top-[25px]">
            ...
            <x-custom.link :url="route('routes.create')">Add New</x-custom.link>
        </div>
            ...
            <div class="dataTable-container">
                <table id="products-table" class="whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <th style="width: 30%;"><a href="#">Origin</a></th>
                        <th style="width: 30%;"><a href="#">Destination</a></th>
                   ...
                   @foreach($routes as $route)
                       <tr>
                           ...
                           <td><span class="{{\App\Enums\Status::tryFrom($route->status)->statusClass()}}">{{ \App\Enums\Status::tryFrom($route->status)->status() }}</span></td>
                           <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                               <a  href="{{ route('routes.edit', $route->id) }}" type="button" x-tooltip="Edit">
                               ...
                               <x-custom.button-destroy route="routes.destroy" :id="$route->id" />
